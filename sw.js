const CACHE='prf-v0.4.2';
const ASSETS=['./','./index.html','./styles.css?v=042','./concept2-v030.css?v=042','./setup-v040.css?v=042','./app.js?v=042','./workout-v022.js?v=042','./setup-v040.js?v=042','./concept2-v030.js?v=042','./manifest.webmanifest?v=042','./icon.svg?v=042'];
